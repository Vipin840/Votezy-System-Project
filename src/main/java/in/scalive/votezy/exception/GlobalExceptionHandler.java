...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleResponseNotFoundException(ResourceNotFoundException ex)
	{
	...
	public ResponseEntity<ErrorResponse> DuplicateResponseException(DuplicateResourceException ex)
	{
